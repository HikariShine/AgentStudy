...
def main() -> int:
    ...
    ap.add_argument("--base-url", default="", help="Custom API base URL (e.g. https://your-proxy.com/v1). Defaults to OPENAI_BASE_URL env or official API.")
    ...
    base_url = (args.base_url or os.environ.get("OPENAI_BASE_URL") or "https://api.openai.com").strip()
