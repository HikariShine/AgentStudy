...
def main():
    ...
    if base_url:
        # Standardize Gemini API path: use v1beta and base_url without manual versioning
        client_config["http_options"] = {"api_version": "v1beta", "base_url": base_url}
        print(f"Using base URL: {base_url} with api_version: v1beta")
